...
# Use the latest CaaSP build here from https://download.opensuse.org/repositories/devel:/CaaSP:/images/images/
IMAGE_FILE="openSUSE-Tumbleweed-Kubic.x86_64-15.0-CaaSP-Stack-kvm-and-xen-Build8.53.qcow2"
