...
VM_LIST="${COURSE_ID}-master01 ${COURSE_ID}-master02 ${COURSE_ID}-master03 ${COURSE_ID}-worker10 ${COURSE_ID}-worker11 ${COURSE_ID}-worker12 ${COURSE_ID}-worker13 ${COURSE_ID}-worker14"
